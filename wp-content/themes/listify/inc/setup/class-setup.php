...
/** Place any new code below this line */";
	...
	public static function _setup_guide_intro() {
		...
		<p class="about-text"><?php echo wp_kses_post( __( 'The last directory you will ever buy. Use the steps below to finish setting up your new website. If you have more questions please <a href="http://listify.astoundify.com" target="_blank">review the documentation</a>.', 'listify' ) ); ?></p>
		<div class="setup-guide-theme-badge"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/inc/setup/assets/images/banner.jpg" style="width:140px;" alt="" /></div>
		...
		<script type="text/javascript">window.Beacon('init', 'd49a7334-6522-4968-9950-54fc11d6f783')</script>
