...
class Listify_WP_Job_Manager_Template_Single_Listing {
	...
	public static function enqueue_scripts() {
		...
		$comments_var = array(
			'defaultRating' => apply_filters( 'listify_ratings_default_rating', 0 ),
		);

		wp_enqueue_script(
			'listify-app-listing',
			listify_get_asset_src(  '/inc/integrations/wp-job-manager/js/listing/app', 'js' ),
			array( 'jquery', 'listify', 'wp-util', 'listify-map' ),
			listify_get_version(),
			true
		);
