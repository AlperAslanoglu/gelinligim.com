...
class Listify_WooCommerce_Bookings extends Listify_Integration {
	...
	public function get_bookable_products( $post_id ) {
		if ( ! class_exists( 'WP_Job_Manager_Products' ) ) {
			echo wp_kses_post( __( 'Make sure that you installed and activated the <a href="https://astoundify.com/downloads/wp-job-manager-products/" target="_blank">WP Job Manager - Products</a> in order to use the bookings widget.', 'listify' ) );
			return;
		}
